...
openai_api_key = os.getenv("ALL_API_KEY")
deepseek_api_key =os.getenv("ALL_API_KEY")
google_api_key = os.getenv("ALL_API_KEY")
...
if 'openai_api_key' in st.session_state:
    player_x = Agent(
        name="Player X",
        model=OpenAILike(id="claude-3-5-sonnet-20240620", api_key=st.session_state.google_api_key,base_url="https://api.sree.shop/v1"),
        instructions=[
    ...
    if 'deepseek_api_key' in st.session_state:
        player_o = Agent(
            name="Player O",
            model=OpenAILike(id="deepseek-v3", api_key=st.session_state.deepseek_api_key,base_url="https://api.sree.shop/v1"),
            instructions=[
    ...
    judge = Agent(
        name="Judge",
        model=OpenAILike(id="gpt-4o", api_key=st.session_state.openai_api_key,base_url="https://api.sree.shop/v1"),
        instructions=[
